                ...
                <form action="./database/function.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="w-50 input-group flex-nowrap form-group col-md-6  pt-3 ">
                            ...
                            <input type="text" class="form-control" name="fname" placeholder="Full Name" id="fname" disabled value="<?php echo $row["name"]; ?>">
                        </div>
                        <div class="w-50 input-group flex-nowrap form-group col-md-6 pt-3 ">
                            <span class="input-group-text">
                                <i class="bi bi-person-fill"></i> </span>
                            <select class="text-center form-control" name="DonorType" placeholder="Donor Type" id="DonorType" required>
                    ...
                    <div class=" row ">
                        ...
                        <div class="w-50 input-group flex-nowrap form-group col-md-6 pt-3 ">
                            ...
                            <select class="text-center form-control" name="OrganType" placeholder="Organ Type" id="OrgaType" required>
                    ...
                    <div class="row">
                        <div class="w-20 input-group flex-nowrap form-group  col-md-6  pt-3 ">
                            ...
                            <textarea placeholder="Comments" name="comments" class="form-control" id="exampleFormControlTextarea1" rows="2"></textarea>
                        </div>
                    </div>
                    <!-- Clear & Submit Button -->
                    <div class="row ">
