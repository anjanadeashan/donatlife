...
<div class="container whiteCard my-6">
        <div class="row d-flex justify-content-between">
            ...
            <div class="grayCardR col-9 px-4">
                ...
                <div class="adH"><i class="bi bi-person-heart pe-3"></i> USER DETAILS</div>
                ...
                <div class="adCard d-flex align-content-center flex-wrap">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body m-2 p-3">
                            ...
                            <h6 class="card-subtitle mb-3 text-muted">Telephone number: </h6>
                            <h6 class="card-subtitle mb-3 text-muted">Blood group: </h6>
