...
<body class=" m-0 border-0">
    ...
    <!-- Cover Page -->
    <div class="container flex-wrap bg-c ">

        <div class="row d-flex flex-wrap justify-content-left donateLifeCoverHead col-6 p-5">
            Donate <br /> Life
        </div>

        <div class="row d-flex flex-wrap justify-content-lefr donateLifeCoverDis px-5">
            THE GIFT OF <br />
            ORGAN DONATION IS<br />
