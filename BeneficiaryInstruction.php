...
<body class="m-0 border-0">
    ...
    <div class="d-flex justify-content-center pt-4 pb-2 mb-4 red mt-3 h1"> Beneficiary Instructions </div>
    <div class="container flex-wrap justify-content-center card inst col-6 mt-4 py-4">
        <div class="card inst-sub px-4 py-3 justify-content-top owerflow-auto">
            <ul type="disk">
                <li>
                    You can request one organ at one time. </li>
                <li>
                    You can communicate with hospital provided of details. </li>
                <li>
                    If we are providing some advice you should follow this. </li>
                <li>
                    You can provide other organs for us. </li>
                <li>
                    If you are the beneficiary,then you prove it. </li>
            </ul>
        </div>
    </div>
