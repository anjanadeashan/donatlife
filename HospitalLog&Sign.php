                    ...
                    <div class="container-form">
                        ...
                        <form action="./database/function.php" onsubmit="return checkValidate()" method="post">
                            <div class="signup">
                                            ...
                                            <td class="p-0">
                                                <div class="input-group flex-nowrap form-group">
                                                    ...
                                                    <input type="text" class="input" name="fname"
                                                        placeholder="Hospital name" id="Hname" required>
                                                </div>
                                            </td>
                                            <td class="p-0">
                                                <div class="input-group flex-nowrap form-group">
                                                    ...
                                                    <input type="text" class="input" name="hid"
                                                        placeholder="Hospital id" id="Hid" required>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <button type="submit" class="submit-btn" name="h_sign_up">Sign Up</button>
                    ...
                    <form action="./database/function.php" method="post">
                        <div class="login slide-up">
                            ...
                            <div class="center">
                                ...
                                <button type="submit" class="submit-btn" name="h_log_in">Login</button>
